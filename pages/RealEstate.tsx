...
import { realEstateContent } from '../content/realEstate';
...
const RealEstate: React.FC = () => {
  const { seo, hero, mainText, who, assets, mechanism, parameters, tax, risks, faq } = realEstateContent;
  ...
  useSEO(seo.title, seo.description, '/real-estate', schema);
      ...
      <div className="bg-white pt-32 pb-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex items-center text-[10px] text-corporate-400 font-bold uppercase tracking-[0.2em] space-x-3">
              ...
              <div className="w-1 h-1 bg-gray-300 rounded-full"></div>
              <span className="text-corporate-900">Недвижимость</span>
           </div>
        </div>
      </div>
