    ...
    <Layout>
      ...
      <div className="bg-white pt-32 pb-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex items-center text-[10px] text-corporate-400 font-bold uppercase tracking-[0.2em] space-x-3">
              ...
              <span className="text-corporate-900">Альтернатива кредиту</span>
           </div>
        </div>
      </div>
      ...
      <Section>
        <div className="max-w-4xl">
          ...
          <div className="space-y-8 text-2xl text-corporate-700 leading-tight font-light">
            <p>{whyDenied.text}</p>
            <p className="text-corporate-900 font-bold font-display">{whyDenied.subText}</p>
          </div>
        </div>
      </Section>
      ...
      {/* 3. NOT OPTIMAL */}
      <Section dark>
        <div className="bg-white p-10 md:p-12 rounded-3xl border border-gray-100 shadow-card max-w-4xl border-l-[12px] border-accent">
      ...
      <Section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {alternatives.items.map((item, index) => (
            <div key={index} className="bg-white p-10 rounded-2xl border border-gray-100 shadow-card hover:shadow-xl transition-all duration-300 group">
              <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center text-corporate-900 mb-8 group-hover:bg-accent group-hover:text-white transition-colors duration-300">
