...
const Finansirovanie: React.FC = () => {
  ...
  return (
    <Layout>
      ...
      <div className="bg-corporate-900 pt-24 pb-4 border-b border-corporate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex items-center text-xs text-corporate-400 uppercase tracking-wider space-x-2">
              ...
              <span className="text-white">Финансирование бизнеса</span>
           </div>
        </div>
      </div>
      ...
      <Section dark>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {methods.items.map((item, index) => (
            <div key={index} className="bg-white p-8 rounded-sm border border-corporate-200 shadow-sm flex gap-6">
              <div className="shrink-0">
                <div className="w-12 h-12 bg-corporate-50 rounded-sm flex items-center justify-center text-corporate-900">
      ...
      <Section>
        <div className="bg-corporate-50 border border-corporate-200 p-8 md:p-10 rounded-sm">
